  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col items-center justify-center p-4 font-body">
      <div className="text-center max-w-md">
        <h1 className="text-[120px] font-bold text-[#0F172A] font-display leading-none mb-4 tracking-tighter">404</h1>
        <h2 className="text-2xl font-semibold text-[#0F172A] mb-4">Page Not Found</h2>
